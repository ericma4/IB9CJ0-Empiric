...
def bbw4_factor_construction(    database_type    = 'trace'        ,
    ...
    if sample_type == 'bbw':
        Replicated_Factors = Replicated_Factors[Replicated_Factors.index<="2022-12-31"]
        Replicated_Factors = Replicated_Factors[Replicated_Factors.index>="2004-08-31"] 
    else:
        pass
