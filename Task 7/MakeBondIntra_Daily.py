...
PricesExport.to_csv('prices_daily.csv.gzip'     , compression='gzip')   
VolumeExport.to_csv('volumes_daily.csv.gzip'    , compression='gzip')     
CleaningExport.to_csv('cleaning_daily.csv') 
# =============================================================================     