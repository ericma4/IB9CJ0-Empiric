...
df = df[[ 'bond_ret', 'bond_amount_out',
          'offering_amt' ,  'spr_mr_fill', 
          'yld','tmt' ,'sic_code']]
...
dfC =\
pd.read_hdf('credit_spreads_updated.h5')
...
ff_factors = ff_factors.iloc[:1161,:]
